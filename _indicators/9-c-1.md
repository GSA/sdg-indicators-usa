...
comments_and_limitations: >-
  ...
  year's data on 3G+ and 2G+ coverage.  Note that for 2015 and 2016 data, 2G+
  coverage appears simply as total mobile coverage, since "2G or faster"
  captures all digital air interfaces, and (1G) analog service is no longer
  offered.  Note also that since the measures are 3G or faster and 2G or faster,
  it is the gap between the two figures that gives the coverage of 2G only, or
  narrowband, service.
